...
public class Control {
    ...
    Location sprouts = new Location(550, 0, 620, 160, "Sprouts", 610, 50);
    Location scripps = new Location(200, 0, -25, 160, "Scripps Medical", 5, 50);
    Location bab = new Location(550, 400, 620, 400, "Board and Brew", 5, 440);
    Location m = new Location(200, 400, -25, 400, "Mr. M's house", 590, 440);
    Location[] locations = {sprouts, scripps, bab, m};
    Wall[] walls = {sprouts.getVertical(), sprouts.getHorizontal(), scripps.getVertical(), 
        scripps.getHorizontal(), bab.getVertical(), bab.getHorizontal(), m.getVertical(),
        m.getHorizontal()};
    Rectangle[] r = {sprouts.getVertical().getBounds(), sprouts.getHorizontal().getBounds(), 
        scripps.getVertical().getBounds(), 
        scripps.getHorizontal().getBounds(), bab.getVertical().getBounds(), bab.getHorizontal().getBounds(), 
        m.getVertical().getBounds(), m.getHorizontal().getBounds()};
    /*
    ...
    walls.add(i.getVertical());
    walls.add(i.getHorizontal());
    r.add(i.getVertical().getBounds());
    r.add(i.getHorizontal().getBounds());
    }
    }
    /*
